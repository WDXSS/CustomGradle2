...
import com.example.customview.list.viewpage.v2.lib.AnimManager;
import com.example.customview.list.viewpage.v2.lib.GalleryRecyclerView;
...
public class GalleryRecyclerViewActivity extends AppCompatActivity implements GalleryRecyclerView.OnItemClickListener, RecyclerAdapter.OnItemPhotoChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gallery_rececler_view);
        ...
        final RecyclerAdapter adapter = new RecyclerAdapter(GalleryRecyclerViewActivity.this, getDatas());
...
//                mRecyclerView.smoothScrollToPosition(progress);
    ...
    public List<Integer> getDatas() {
        TypedArray ar;
        ar = getResources().obtainTypedArray(R.array.test_arr);
