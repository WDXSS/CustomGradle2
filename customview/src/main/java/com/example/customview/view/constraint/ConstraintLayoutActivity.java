...
public class ConstraintLayoutActivity extends AppCompatActivity {
    ...
    public void groupActivity(View view) {
        startActivity(new Intent(this, ConstrainGroupActivity.class));
    }

    //7. Placeholder 占位符
    public void PlaceholderActivity(View view) {
        startActivity(new Intent(this, ConstrainPlaceholderActivity.class));
    }
    //8. 动画
