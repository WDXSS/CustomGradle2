 ...
 */
public class FlowLayoutBook extends ViewGroup {
    public FlowLayoutBook(Context context) {
        super(context);
    }

    public FlowLayoutBook(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FlowLayoutBook(Context context, AttributeSet attrs, int defStyleAttr) {
