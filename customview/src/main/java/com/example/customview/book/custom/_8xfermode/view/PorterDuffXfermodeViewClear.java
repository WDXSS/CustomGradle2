...
public class PorterDuffXfermodeViewClear extends View {
    ...
    public PorterDuffXfermodeViewClear(Context context) {
        this(context, null);
    }

    public PorterDuffXfermodeViewClear(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PorterDuffXfermodeViewClear(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        canvas.drawText("PorterDuff.Mode.CLEAR ",  10, heigth *2, mPaintText);
        //保存状态
