...
public class PorterDuffXfermodeViewDstIn extends View {
    ...
    public PorterDuffXfermodeViewDstIn(Context context) {
        this(context, null);
    }

    public PorterDuffXfermodeViewDstIn(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PorterDuffXfermodeViewDstIn(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        canvas.drawText("PorterDuff.Mode.DST_IN ",  10, heigth + 50, mPaintText);
        //保存状态
