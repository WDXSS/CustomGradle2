...
public class PorterDuffXfermodeViewDstOut extends View {
    ...
    public PorterDuffXfermodeViewDstOut(Context context) {
        this(context, null);
    }

    public PorterDuffXfermodeViewDstOut(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PorterDuffXfermodeViewDstOut(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        canvas.drawText("PorterDuff.Mode.DST_OUT ",  10, height *2, mPaintText);
