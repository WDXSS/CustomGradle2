...
public class PorterDuffXfermodeViewOverlay extends View {
    ...
    public PorterDuffXfermodeViewOverlay(Context context) {
        this(context, null);
    }

    public PorterDuffXfermodeViewOverlay(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PorterDuffXfermodeViewOverlay(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        canvas.drawText("PorterDuff.Mode.OVERLAY  叠加", 10, heigth*2, mPaintText);
        //保存状态
