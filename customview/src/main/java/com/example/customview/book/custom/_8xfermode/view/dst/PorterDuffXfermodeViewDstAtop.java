...
public class PorterDuffXfermodeViewDstAtop extends View {
    ...
    public PorterDuffXfermodeViewDstAtop(Context context) {
        this(context, null);
    }

    public PorterDuffXfermodeViewDstAtop(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PorterDuffXfermodeViewDstAtop(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        //绘制文字
        canvas.drawText("PorterDuff.Mode.DST_ATOP ", 10, height * 2, mPaintText);
