 ...
 */
public class MyLinLayoutBook extends ViewGroup{
    public MyLinLayoutBook(Context context) {
        super(context);
    }

    public MyLinLayoutBook(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MyLinLayoutBook(Context context, AttributeSet attrs, int defStyleAttr) {
