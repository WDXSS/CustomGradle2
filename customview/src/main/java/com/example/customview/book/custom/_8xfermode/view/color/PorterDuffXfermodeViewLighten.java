...
public class PorterDuffXfermodeViewLighten extends View {
    ...
    public PorterDuffXfermodeViewLighten(Context context) {
        this(context, null);
    }

    public PorterDuffXfermodeViewLighten(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PorterDuffXfermodeViewLighten(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        canvas.drawText("PorterDuff.Mode.LIGHTEN 变亮", 10, heigth*2, mPaintText);
        //保存状态
