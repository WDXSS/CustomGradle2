...
public class PorterDuffXfermodeViewAdd extends View {
    ...
    public PorterDuffXfermodeViewAdd(Context context) {
        this(context, null);
    }

    public PorterDuffXfermodeViewAdd(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PorterDuffXfermodeViewAdd(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        canvas.drawText("PorterDuff.Mode.ADD  饱和度相加", 10, heigth*2, mPaintText);
        //保存状态
