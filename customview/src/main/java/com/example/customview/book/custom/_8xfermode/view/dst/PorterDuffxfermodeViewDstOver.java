...
public class PorterDuffxfermodeViewDstOver extends View {
    ...
    public PorterDuffxfermodeViewDstOver(Context context) {
        this(context, null);
    }

    public PorterDuffxfermodeViewDstOver(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PorterDuffxfermodeViewDstOver(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        //输出文字
        canvas.drawText("PorterDuff.Mode.DST_OVER ", 10, height * 2, mPaintText);
