...
public class PorterDuffXfermodeViewScreen extends View {
    ...
    public PorterDuffXfermodeViewScreen(Context context) {
        this(context, null);
    }

    public PorterDuffXfermodeViewScreen(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PorterDuffXfermodeViewScreen(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        canvas.drawText("PorterDuff.Mode.SCREEN  滤色", 10, heigth*2, mPaintText);
        //保存状态
