...
public class PorterDuffXfermodeViewSrc extends View {
    ...
    public PorterDuffXfermodeViewSrc(Context context) {
        this(context, null);
    }

    public PorterDuffXfermodeViewSrc(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PorterDuffXfermodeViewSrc(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        canvas.drawText("PorterDuff.Mode.SRC ",  10, heigth *2, mPaintText);
        //保存状态
