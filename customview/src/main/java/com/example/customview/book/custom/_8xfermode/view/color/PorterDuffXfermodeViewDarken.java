...
public class PorterDuffXfermodeViewDarken extends View {
    ...
    public PorterDuffXfermodeViewDarken(Context context) {
        this(context, null);
    }

    public PorterDuffXfermodeViewDarken(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PorterDuffXfermodeViewDarken(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        canvas.drawText("PorterDuff.Mode.DARKEN  变暗", 10, heigth*2, mPaintText);
        //保存状态
