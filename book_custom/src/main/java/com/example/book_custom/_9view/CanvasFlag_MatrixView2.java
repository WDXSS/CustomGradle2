...
@DevDescribe("新的Api 已经不支持 canvas.save(Canvas.MATRIX_SAVE_FLAG); 中的入参 Canvas.MATRIX_SAVE_FLAG" +
        "对画布进行裁剪")
public class CanvasFlag_MatrixView2 extends View {
    private Paint mPaint;
    public CanvasFlag_MatrixView2(Context context) {
        this(context, null);
    }

    public CanvasFlag_MatrixView2(Context context, @Nullable AttributeSet attrs) {
...
//
    ...
    public CanvasFlag_MatrixView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
